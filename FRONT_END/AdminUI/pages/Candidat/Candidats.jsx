...
import "./Candidat.css";
import { Table } from "../../../../FRONTEND/Components/Details/DetailsCandidat/Table";
import { Modal } from "../../../../FRONTEND/Components/Details/DetailsCandidat/Modal";
...
function Candidats() {
  ...
  const handleDeleteRow = (targetIndex) => {
    ...
    fetch(
      `http://localhost:8080/candidats/deleteCandidat/${candidatToDelete.id_candidat}`,
      {
        method: "DELETE",
      }
    )
  ...
  const handleSubmit = (newRow) => {
    if (rowToEdit === null) {
      ...
      fetch(
        `http://localhost:8080/candidats/editCandidat/${candidatToUpdate.id_candidat}`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
