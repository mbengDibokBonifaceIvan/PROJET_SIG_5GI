...
import { Table } from "../../../../FRONTEND/Components/Details/DetailsCentreVote/Table";
import { Modal } from "../../../../FRONTEND/Components/Details/DetailsCentreVote/Modal";
...
function CentreVote() {
  ...
  useEffect(() => {
    const fetchCentres = async () => {
      try {
        ...
        const response = await fetch(
          "http://localhost:8080/centres-de-vote/all"
        );
    ...
    const fetchArrondissements = async () => {
      try {
        const response = await fetch(
          "http://localhost:8080/arrondissements/all"
        );
        if (!response.ok)
