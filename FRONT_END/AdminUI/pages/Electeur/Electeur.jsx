...
import "./Electeur.css";
import { Table } from "../../../../FRONTEND/Components/Details/DetailsElecteur/Table";
import { Modal } from "../../../../FRONTEND/Components/Details/DetailsElecteur/Modal";
  ...
  useEffect(() => {
    const fetchElecteurs = async () => {
      try {
        ...
        if (!response.ok)
          throw new Error("Erreur de récupération des electeurs");
