...
import { Table } from "../../../../FRONTEND/Components/Details/DetailsBureauVote/Table";
import { Modal } from "../../../../FRONTEND/Components/Details/DetailsBureauVote/Modal";
...
function BureauVote() {
    ...
    try {
      ...
      if (rowToEdit === null) {
        ...
        response = await fetch(
          "http://localhost:8080/bureaux-de-vote/addBureauDeVote",
          {
            method: "POST",
  ...
  return (
    <div className="BureauVote">
      <Table
        rows={rows}
        deleteRow={(idx) => handleDeleteRow(rows[idx].id_bureau_vote)}
